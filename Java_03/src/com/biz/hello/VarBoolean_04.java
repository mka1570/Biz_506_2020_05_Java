...
public class VarBoolean_04 {
	...
	public static void main(String[] args) {
		 ...
		 *
		 *  변수를 선언한 후 어떠한 값을 저장하는 것을 변수를 초기화 한다 라고 한다.
		 *  변수는 초기화가 되어야만 사용(읽기, 쓰기) 가 가능하다.
		 *  
		 *  변수는 기본적으로 제공되는 int, float, long, double, boolean, char 들은 키워드 변수 = 값 형식으로 선언과 초기화를 할수 있다.
		 *    
		 */
		String str1 = "대한민국";
		 ...
		 * 기본적으로 제공되지 않는 필요에 따라 JDK를 import 해서 선언하는 변수들은 초기화 하는 방법이 족므 다르다.
		 * 
		 * 키워드 변수 =  new 키워드()
		 ...
		 *  .nextInt)_ method를 연결하여 명령문이 완성되고
		 *  임의의 정수를 만들어서 왼쪽의 변수에 저장하는 역할을 수행한다.
		 *  
		 *  .nextInt(100) method를 연결하면 이 명령문은 0 부터 99까지의 임의 정수를 만들어 num1변수에 저장한다.
		 *  
		 */
