...
public class Grade_01 {
	...
	public static void main(String[] args) {
		...
		// 각 학생의 총점, 평균을 계산하여 stdSum, stdAvg 저장
		for(int i = 0; i < stdCount ; i++) {
	...
	System.out.println("----------------------------------------------------");
	System.out.printf("%s\t%d\t%d\t%d\t%d\t%d\t%d\n","총점",intKorSum,intEngSum,intMathSum,
			intMusicSum,intArtSum,totalSum,totalAvg);
	System.out.printf("%s\t%d\t%d\t%d\t%d\t%d\t%d\n","평균",intKorSum/stdCount,intEngSum/stdCount,
			intMathSum/stdCount,
			intMusicSum/stdCount,intArtSum/stdCount,totalSum/stdCount,totalAvg/stdCount);
	System.out.println("====================================================");
